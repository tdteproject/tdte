        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {industries.map((ind, index) => (
            <div
              ...
              onClick={() => handleCardClick(ind.linkTo)}
            >
              <div
                className="relative w-full h-full rounded-md transition-transform duration-700 ease-in-out shadow-md group-hover:[transform:rotateY(180deg)]"
